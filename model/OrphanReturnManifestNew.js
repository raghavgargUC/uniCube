cube('OrphanReturnManifestNew', {
  sql: `
    ...
    WHERE t.code = '${COMPILE_CONTEXT.securityContext.tenant_code}'
  `,
  data_source: 'default',

  refresh_key: {
    sql: `SELECT CONCAT('${COMPILE_CONTEXT.securityContext.tenant_code}', ':OrphanReturnManifestNew')`,
    every: `${COMPILE_CONTEXT.securityContext.subscriptions?.OrphanReturnManifestNew?.refresh_every || '1 hour'}`,
  },
